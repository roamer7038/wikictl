...
// notFoundError is a page that does not exist.
...
// exitCode returns the exit code and the "error" field of err. A
// notFoundError, like any error of no type defined here, is a general error.
