...
the name, and the summary, or the title when the page has no summary; "-" marks
an empty type or time. A path that does not exist is reported on standard error,
