...
func printUsage(w io.Writer) {
	...
	tw.Flush()
	fmt.Fprintln(w)
	fmt.Fprintln(w, "Flags may come before or after the arguments, and short flags may be combined")
	fmt.Fprintln(w, "(-ab). Every argument after -- is an argument, even if it starts with -.")
	fmt.Fprintln(w)
