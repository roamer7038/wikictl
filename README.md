...
- File and directory names must not be empty, start with `.`, or contain whitespace, control characters or any of `" \ # )`; pages end in `.md`. `put` and `mv` reject other paths (`bad_path`, exit code 4).
