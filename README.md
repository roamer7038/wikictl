...
| 4 | the page violates the wiki format: `put` rejects invalid frontmatter or a bad path, `mv` a bad source or destination path, and `rm` a bad path; `lint` exits with 4 on any finding |
