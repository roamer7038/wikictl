...
| 4 | the page violates the wiki format: `put` rejects invalid frontmatter or a bad path, and `mv` a bad source or destination path; `lint` exits with 4 on any finding |
